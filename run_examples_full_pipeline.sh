...
run_one_pdf() {
  ...
  DOC2X_BASE_URL="$DOC2X_BASE_URL" \
  DOC2X_TIMEOUT="$DOC2X_TIMEOUT" \
  DOC2X_POLL_INTERVAL="$DOC2X_POLL_INTERVAL" \
...
md2json_options = {
    "prompt_profile": os.environ.get("PROMPT_PROFILE", "textbook"),
    "structure_mode": os.environ.get("STRUCTURE_MODE", "llm"),
    "audit_mode": os.environ.get("AUDIT_MODE", "llm"),
}
